/* ========================================
   Mono Theme — Portfolio Interactions
   ======================================== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (badge) {
        ...
        let i = 0;
        function typeChar() {
            if (i < text.length) { badge.textContent += text[i]; i++; setTimeout(typeChar, 50 + Math.random() * 20); }
        }
    ...
    console.log('%c Elena Matyushenko %c Mono Theme ', 'background: #111; color: white; font-size: 14px; font-weight: bold; padding: 4px 8px;', 'background: #fafafa; color: #111; font-size: 14px; padding: 4px 8px; border: 1px solid #ddd;');
});
