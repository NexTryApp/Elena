/* ========================================
   Ocean Theme — Portfolio Interactions
   ======================================== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('%c Elena Matyushenko %c Ocean Theme ', 'background: #2e7bba; color: white; font-size: 14px; font-weight: bold; padding: 4px 8px; border-radius: 4px 0 0 4px;', 'background: #e0eef8; color: #2e7bba; font-size: 14px; padding: 4px 8px; border-radius: 0 4px 4px 0;');
});
